<script>
    import { HelpCircle, Menu, X } from '@lucide/svelte';
...
<!-- Mobile Menu Overlay -->
{#if isOpen}
    <div class="fixed inset-0 z-40 bg-surface md:hidden pt-24" transition:slide={{ duration: 300 }}>
        <div class="flex flex-col gap-6 px-gutter">
